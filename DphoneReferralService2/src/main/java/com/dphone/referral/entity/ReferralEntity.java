...
public class ReferralEntity {
	...
	public ReferralEntity(int referral_id, String first_name, String last_name, long mobile, String email,
	...
	public String toString() {
		return "ReferralEntity [referral_id=" + referral_id + ", first_name=" + first_name + ", last_name=" + last_name
